    ...
    module.config(function ($stateProvider, $couchPotatoProvider) {
        ...
        $stateProvider
            .state('app.inbox', {
                ...
                views: {
                    content: {
                        templateUrl: 'app/modules/inbox/views/inbox-layout.html',
                        ...
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
                                'modules/inbox/directives/messageLabels'
                            ]),
            ...
            .state('app.inbox.folder', {
                ...
                views: {
                    inbox: {
                        templateUrl: 'app/modules/inbox/views/inbox-folder.html',
            ...
            .state('app.inbox.folder.detail', {
                ...
                views: {
                    "inbox@app.inbox": {
                        templateUrl: 'app/modules/inbox/views/inbox-detail.html',
            ...
            .state('app.inbox.folder.replay', {
                ...
                views: {
                    "inbox@app.inbox": {
                        templateUrl: 'app/modules/inbox/views/inbox-replay.html',
            ...
            .state('app.inbox.folder.compose', {
                ...
                views: {
                    "inbox@app.inbox": {
                        templateUrl: 'app/modules/inbox/views/inbox-compose.html',
