define(['angular', 'angular-couch-potato', 'lodash', 'angular-ui-router', 'angular-resource'], function (ng, couchPotato, _) {
    ...
    module.config(function ($stateProvider, $couchPotatoProvider) {
        $stateProvider.state('app.inbox', {
            ...
            views: {
                content: {
                    templateUrl: 'app/components/inbox/partials/inbox-layout.html',
        ...
        .state('app.inbox.folder', {
            ...
            views: {
                inbox: {
                    templateUrl: 'app/components/inbox/partials/inbox-folder.html',
        ...
        .state('app.inbox.folder.detail', {
            ...
            views: {
                "inbox@app.inbox": {
                    templateUrl: 'app/components/inbox/partials/inbox-detail.html',
        ...
        .state('app.inbox.folder.replay', {
            ...
            views: {
                "inbox@app.inbox": {
                    templateUrl: 'app/components/inbox/partials/inbox-replay.html',
        ...
        .state('app.inbox.folder.compose', {
            ...
            views: {
                "inbox@app.inbox": {
                    templateUrl: 'app/components/inbox/partials/inbox-compose.html',
